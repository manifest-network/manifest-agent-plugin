...
explicit release prerequisite; no checkbox is completed by inference.

Implementation status (2026-09-11): phases 1–3 are implemented; phase 4 has
automated fixtures, current Codex app-server evidence and pinned-runtime
contracts; phase 5 has installation/recovery docs, CI artifacts and a release
gate. Local validation passes all 502 tests on Node 24.15.0, native plugin
